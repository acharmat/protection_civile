                    ...
                    <div class="box-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control"  id="designation"  value="{{ $service->designation }}" disabled>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="lits">Lits</label>
                                <input type="number" class="form-control" name="lits" id="lits" placeholder="Lits" value="{{ $hopitalservice->lits }}" required>
                            </div>
